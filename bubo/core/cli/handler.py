...
class CLIHandler:
    ...
    def parse_args() -> CLIOptions:
        ...
        input_group.add_argument("--single", "-d", metavar="DOMAIN", help="Single domain to validate")
        input_group.add_argument(
            "--batch", "-b", metavar="DOMAINS_LIST.[csv|txt]", help="Batch mode - Path to file containing domains"
        )
