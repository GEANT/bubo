...
_strength_ciphers: Optional[Dict[str, List[str]]] = None
_cipher_details: Optional[Dict[str, CipherDetails]] = None
_cipher_to_strength: Optional[Dict[str, CipherStrength]] = None
...
def classify_cipher(
    ...
    has_pfs = any(x in kx_value for x in ["ECDH", "DH"]) and not kx_value == "RSA"
